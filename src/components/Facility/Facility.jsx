        ...
        <div className="col-span-12 flex sm:col-span-6 lg:col-span-3">
          <div className="transition-all-300 flex w-full items-center gap-4 rounded-lg p-5 border-2 xs:pl-[20%] sm:pl-5">
            ...
            <div>
              ...
              <p className="break-all text-sm text-[#dc8a03]">
                Orders over $100
              </p>
            </div>
          </div>
        ...
        <div className="col-span-12 flex sm:col-span-6 lg:col-span-3">
          <div className="transition-all-300 flex w-full items-center gap-4 rounded-lg p-5 border-2 xs:pl-[20%] sm:pl-5">
            ...
            <div>
              ...
              <p className="break-all text-sm text-[#dc8a03]">Any Problem</p>
            </div>
          </div>
        </div>
        <div className="col-span-12 flex sm:col-span-6 lg:col-span-3">
          <div className="transition-all-300 flex w-full items-center gap-4 rounded-lg p-5 border-2 xs:pl-[20%] sm:pl-5">
            ...
            <div>
              ...
              <p className="break-all text-sm text-[#dc8a03]">Secured payment</p>
            </div>
          </div>
        </div>
        <div className="col-span-12 flex sm:col-span-6 lg:col-span-3">
          <div className="transition-all-300 flex w-full items-center gap-4 rounded-lg p-5 border-2 xs:pl-[20%] sm:pl-5">
            ...
            <div>
              ...
              <p className="break-all text-sm text-[#dc8a03]">Support 24/7</p>
            </div>
          </div>
        </div>
      </div>
