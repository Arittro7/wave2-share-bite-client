    ...
    return (
        <div className="container px-6 py-10 mx-auto">
            <div className="text-center">
                <h1 className="text-2xl font-semibold text-[#8b9710] capitalize lg:text-3xl dark:text-[#dc8a03]">Our Top Foods</h1>
                <p className="max-w-lg mx-auto mt-4 mb-6 text-black">
            ...
            <div className="mt-8 text-center">
                ...
                >
                    ...
                    <span className="w-48 h-48 rounded rotate-[-40deg] bg-[#9d174d] absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
