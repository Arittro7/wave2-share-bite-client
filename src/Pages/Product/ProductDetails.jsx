    ...
    <div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:py-16 h-full lg:flex-row lg:items-center">
        ...
        <div className="w-full lg:w-1/2">
            <div className="lg:max-w-lg">
                <h1 className="text-3xl font-semibold tracking-wide dark:text-gray-800 text-white lg:text-4xl flex items-center gap-2"><MdNoFood />{foodName}</h1>
                <p className="mt-4 text-black">Price: ${price}</p>
                <p className="mt-4 text-black flex items-center gap-2"><BiCategory />Category: {foodCategory}</p>
                <p className="mt-4 text-black flex items-center gap-2"><IoIosBasket/> Quantity: {quantity}</p>
                <p className="mt-4 text-black flex items-center gap-2"><SiHomebridge/> Food Origin Country: {foodOriginCountry}</p>
                <p className="mt-4 text-black flex items-center gap-2"><IoPersonOutline /> Made By: {buyer.name}</p>
